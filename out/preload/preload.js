...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  reverseApplyPatch: (projectPath, patches) => electron.ipcRenderer.invoke("fs:reverseApplyPatch", projectPath, patches),
  ...
  agentReloadConfig: (agentId, sessionId) => electron.ipcRenderer.invoke("agent:reloadConfig", agentId, sessionId),
  agentConfigList: (agentId) => electron.ipcRenderer.invoke("agentConfig:list", agentId),
  agentConfigSave: (agentId, config) => electron.ipcRenderer.invoke("agentConfig:save", agentId, config),
  agentConfigActivate: (agentId, providerId) => electron.ipcRenderer.invoke("agentConfig:activate", agentId, providerId),
  agentConfigDelete: (agentId, providerId) => electron.ipcRenderer.invoke("agentConfig:delete", agentId, providerId),
