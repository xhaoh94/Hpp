...
const tabs = [
  {
    id: "projects",
    label: "项目",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3", y: "3", width: "7", height: "7", rx: "1.5", stroke: "currentColor", strokeWidth: "1.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3", y: "14", width: "7", height: "7", rx: "1.5", stroke: "currentColor", strokeWidth: "1.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "14", y: "3", width: "7", height: "7", rx: "1.5", stroke: "currentColor", strokeWidth: "1.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "14", y: "14", width: "7", height: "7", rx: "1.5", stroke: "currentColor", strokeWidth: "1.5" })
    ] })
  },
  {
    id: "files",
    label: "资源管理器",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4 6C4 4.89543 4.89543 4 6 4H10L12 7H18C19.1046 7 20 7.89543 20 9V18C20 19.1046 19.1046 20 18 20H6C4.89543 20 4 19.1046 4 18V6Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinejoin: "round" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4 10H20", stroke: "currentColor", strokeWidth: "1.5" })
    ] })
  },
  {
    id: "settings",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "activity-bar", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: sidebarCollapsed ? /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3", y: "4", width: "18", height: "16", rx: "2", stroke: "currentColor", strokeWidth: "1.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M9 4v16", stroke: "currentColor", strokeWidth: "1.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 10l2 2-2 2", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3", y: "4", width: "18", height: "16", rx: "2", stroke: "currentColor", strokeWidth: "1.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M9 4v16", stroke: "currentColor", strokeWidth: "1.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M14 10l-2 2 2 2", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })
        ] })
      }
    )
  ] }) });
...
const useProjectStore = create((set, get) => ({
  ...
  addSession: (projectId, session) => set((s) => ({
    projects: s.projects.map(
      (p) => p.id === projectId ? { ...p, sessions: [...p.sessions, session] } : p
    ),
    activeSessionId: session.id
  })),
  removeSession: (projectId, sessionId) => set((s) => ({
    projects: s.projects.map(
      (p) => p.id === projectId ? { ...p, sessions: p.sessions.filter((se) => se.id !== sessionId) } : p
    ),
...
function SessionHistoryModal({ isOpen, onClose, sessions, sessionMessages, onResume, onDelete }) {
  const [confirmDelete, setConfirmDelete] = reactExports.useState(null);
  if (!isOpen) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "session-modal-overlay", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "session-modal", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "session-modal-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "session-modal-title", children: "历史会话" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "session-modal-close", children: "×" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "session-modal-body", children: sessions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "session-empty", children: "暂无会话记录" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "session-list", children: sessions.map((session) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "session-item", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "session-item-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "session-time", children: formatTime(session.createdAt) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "session-preview", children: (() => {
        const msgs = sessionMessages[session.id];
        const firstUserMsg = msgs?.find((m) => m.role === "user");
        return firstUserMsg ? firstUserMsg.content.length > 50 ? firstUserMsg.content.substring(0, 50) + "..." : firstUserMsg.content : session.title;
      })() })
    ] }, session.id)) }) }),
    confirmDelete && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "session-confirm-overlay", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "session-confirm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "session-confirm-title", children: "确定删除此会话？" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "session-confirm-desc", children: "删除后无法恢复。" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "session-confirm-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setConfirmDelete(null), className: "session-btn cancel", children: "取消" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          onDelete(confirmDelete);
          setConfirmDelete(null);
        }, className: "session-btn delete", children: "删除" })
      ] })
    ] }) })
  ] }) });
}
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "project-item always-active", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "project-info", children: [
      ...
      project.sessions.some((s) => s.closed) && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          title: "历史会话",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-child-title", children: (() => {
              const msgs = sessionMessages[session.id];
              const firstUserMsg = msgs?.find((m) => m.role === "user");
...
function ProjectView() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "项目" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowAdd(!showAdd), className: "btn-add", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 5v14M5 12h14", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" }) }) })
    ] }),
    showAdd && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "project-form", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          value: name,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "path-input-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            value: path,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleBrowse, className: "btn-browse", children: "浏览" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowAdd(false), className: "btn btn-cancel", children: "取消" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleAdd, className: "btn btn-primary", children: "添加" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-content", children: [
      projects.length === 0 && !showAdd && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "placeholder-text", children: "暂无项目" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "project-list", children: projects.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectCard, { project }, project.id)) })
    ] })
  ] });
}
...
function FileExplorer() {
  ...
  const handleFileClick = reactExports.useCallback((path) => {
    setPreviewFile(path);
  }, []);
  reactExports.useEffect(() => {
    if (activeProject) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-tree", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-tree-search", children: [
      ...
      search && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSearch(""), className: "file-tree-search-clear", children: "×" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "file-tree-content", children: !activeProject ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "placeholder-text", children: "请先选择一个项目" }) : displayEntries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "placeholder-text", children: search ? "无匹配结果" : "空目录" }) : displayEntries.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(FileTreeItem, { entry, depth: 0, highlightedPath: highlightedFile, onFileClick: handleFileClick }, entry.path)) }),
...
function ChatPanel({ sendKey = "Enter" }) {
  ...
  reactExports.useEffect(() => {
    ...
    const handleClick = (e) => {
      if (userMsgHistoryRef.current && !userMsgHistoryRef.current.contains(e.target)) {
  ...
  reactExports.useEffect(() => {
    const handler = (e) => {
      ...
      if (thinkingRef.current && !thinkingRef.current.contains(e.target)) setThinkingOpen(false);
    };
      ...
      switch (event.type) {
        ...
        case "diff_update":
          if (event.diffs && event.diffs.length > 0) {
            ...
            const fileNames = event.diffs.map((diff) => {
              const parts = diff.file.split(/[/\\]/);
              return parts[parts.length - 1];
            });
            const diffTitle = event.diffs.length === 1 ? `已修改文件: ${fileNames[0]}` : `已修改 ${event.diffs.length} 个文件: ${fileNames.slice(0, 3).join(", ")}${event.diffs.length > 3 ? "..." : ""}`;
            appendProcessEntry({
              type: "diff",
              title: diffTitle,
              detail: event.diffs.map((diff) => `${diff.file} (${diff.status === "added" ? "新增" : diff.status === "deleted" ? "删除" : "修改"})`).join("\n"),
              state: "completed",
              expanded: false
            });
          }
  ...
  const handleSend = async () => {
    ...
    if (pendingFiles.length > 0) {
      ...
      for (const pf of pendingFiles) {
        ...
        try {
          const result2 = await window.electronAPI.readFile(pf.filePath);
...
${fileParts.join("\n\n")}` : fileParts.join("\n\n");
  ...
  const handleKeyDown = (e) => {
    ...
    const shouldSend = sendKey === "Ctrl+Enter" && e.key === "Enter" && e.ctrlKey || sendKey === "Enter" && e.key === "Enter" && !e.ctrlKey;
    if (shouldSend) {
      e.preventDefault();
      handleSend();
    } else if (e.key === "Enter") {
  ...
  if (!activeProject) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-empty-state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "48", height: "48", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1", style: { color: "var(--text-secondary)", marginBottom: 16, opacity: 0.5 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4 6C4 4.89543 4.89543 4 6 4H10L12 7H18C19.1046 7 20 7.89543 20 9V18C20 19.1046 19.1046 20 18 20H6C4.89543 20 4 19.1046 4 18V6Z", strokeLinejoin: "round" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4 10H20" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-empty-title", children: "未打开项目" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-empty-desc", children: "请在左侧创建或选择一个项目以开始对话" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 5v14M5 12h14", strokeLinecap: "round" }) }),
            "创建项目"
          ]
        }
      )
  ...
  if (!activeSession) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-empty-state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "48", height: "48", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1", style: { color: "var(--text-secondary)", marginBottom: 16, opacity: 0.5 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "2", y: "3", width: "20", height: "18", rx: "2", stroke: "currentColor", strokeWidth: "1.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M7 8L10 11L7 14", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 14H17", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: userMsgHistoryRef, className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            title: "发言记录",
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
        ...
        userMsgHistoryOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-user-history-popup", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-user-history-header", children: "发言记录" }),
          messages.filter((m) => m.role === "user").length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-user-history-empty", children: "暂无发言" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-user-history-list", children: messages.filter((m) => m.role === "user").map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
...
function highlightMatch(text, pattern) {
  ...
  for (const idx of indices) {
    if (last < idx) parts.push(/* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: text.slice(last, idx) }, `p${idx}`));
    parts.push(/* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "fs-highlight", children: text[idx] }, `m${idx}`));
    last = idx + 1;
  }
  if (last < text.length) parts.push(/* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: text.slice(last) }, "end"));
  return parts;
}
const EXCLUDE_DIRS = /* @__PURE__ */ new Set(["node_modules", ".git", "dist", "build", "__pycache__", ".next", ".nuxt", "out"]);
function FileSearch({ isOpen, onClose, onSelect }) {
  ...
  const { projects, activeProjectId } = useProjectStore();
  const activeProject = projects.find((p) => p.id === activeProjectId);
  const collectFiles = reactExports.useCallback(async (dirPath, depth = 0) => {
    if (depth > 3) return [];
    try {
  ...
  if (!isOpen) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fs-overlay", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fs-modal", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fs-input-wrapper", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "fs-icon", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "11", cy: "11", r: "8", stroke: "currentColor", strokeWidth: "2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21 21L16.65 16.65", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      loading && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "fs-loading", children: "..." })
    ] }),
    results.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fs-results", children: results.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "fs-item-icon", width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", children: item.isDirectory ? /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 6C2 4.89543 2.89543 4 4 4H9L11 6H20C21.1046 6 22 6.89543 22 8V18C22 19.1046 21.1046 20 20 20H4C2.89543 20 2 19.1046 2 18V6Z", stroke: "currentColor", strokeWidth: "1.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M6 2H14L20 8V20C20 21.1046 19.1046 22 18 22H6C4.89543 22 4 21.1046 4 20V4C4 2.89543 4.89543 2 6 2Z", stroke: "currentColor", strokeWidth: "1.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M14 2V8H20", stroke: "currentColor", strokeWidth: "1.5" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fs-item-info", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "fs-item-name", children: highlightMatch(item.name, query) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "fs-item-path", children: item.path })
          ] })
        ]
      },
      item.path
    )) }),
    query && results.length === 0 && !loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fs-empty", children: "未找到匹配的文件" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fs-footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
...
const TitleBar = ({ title = "Hpp" }) => {
  ...
  const handleToggleMaximize = reactExports.useCallback(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-titlebar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "titlebar-drag-region", onDoubleClick: handleToggleMaximize, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "titlebar-title", children: title }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-controls", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          title: "最小化",
          "aria-label": "最小化窗口",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "2", y: "5.5", width: "8", height: "1", fill: "currentColor" }) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: maximized ? /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "12", height: "12", viewBox: "0 0 12 12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3", y: "3", width: "6", height: "6", fill: "none", stroke: "currentColor", strokeWidth: "1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "1", y: "5", width: "6", height: "6", fill: "none", stroke: "currentColor", strokeWidth: "1" })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "2", y: "2", width: "8", height: "8", fill: "none", stroke: "currentColor", strokeWidth: "1" }) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          title: "关闭",
          "aria-label": "关闭窗口",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "12", height: "12", viewBox: "0 0 12 12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "2", y1: "2", x2: "10", y2: "10", stroke: "currentColor", strokeWidth: "1.2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "10", y1: "2", x2: "2", y2: "10", stroke: "currentColor", strokeWidth: "1.2" })
          ] })
        }
      )
    ] })
...
function matchShortcut(event, shortcut) {
  ...
  return parts.includes("ctrl") === event.ctrlKey && parts.includes("shift") === event.shiftKey && parts.includes("alt") === event.altKey && parts.includes("cmd") === event.metaKey && !["ctrl", "shift", "alt", "cmd"].includes(key) && parts.includes(key);
}
function App() {
  useDataPersistence();
  const [showFileSearch, setShowFileSearch] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    window.electronAPI.loadData("settings").then((data) => {
      if (data?.shortcuts) {
        const { cycleModel: cycleModel2, ...rest } = data.shortcuts;
        setShortcuts((prev) => ({ ...prev, ...rest }));
      }
    });
  }, []);
  const cycleModel = reactExports.useCallback((direction) => {
  ...
  const handleFileSelect = reactExports.useCallback((filePath) => {
    useAppStore.getState().setSidebarTab("files");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "layout", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `layout-content ${sidebarCollapsed ? "collapsed" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ContentArea, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChatPanel, { sendKey: shortcuts.sendKey })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FileSearch,
      {
